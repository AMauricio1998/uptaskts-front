                        ...
                        <div className='mb-2'>
                          {
                            isManager(project.manager, user._id) ? (
                              <p className="font-bold text-xs uppercase bg-indigo-50 hover:bg-indigo-500 border-2 border-indigo-500 rounded-lg inline-block py-1 px-5">
                                Manager
                              </p>
                            ) : (
                              <p className="font-bold text-xs uppercase bg-green-50 hover:bg-green-500 border-2 border-green-500 rounded-lg inline-block py-1 px-5">
                                Colaborador
                              </p>
                            )
                          }
